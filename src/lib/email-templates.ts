    ...
    <head>
      ...
      <style>
        @media only screen and (max-width: 600px) {
          ...
          .score-badge { font-size: 24px !important; width: 70px !important; height: 70px !important; line-height: 70px !important; }
          .score-circle { width: 90px !important; height: 90px !important; }
          .score-circle circle { r: 35 !important; }
          .welcome-badge, .alert-badge, .reminder-badge { width: 50px !important; height: 50px !important; line-height: 50px !important; font-size: 24px !important; }
          .progress-bar { width: 100% !important; }
          .social-buttons { flex-direction: column !important; gap: 8px !important; }
          .social-button { width: 100% !important; margin: 0 !important; }
        }
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;margin:0 auto;background:#f9fafb;">
        ...
        <tr>
          <td style="padding:30px;color:#333;font-size:15px;line-height:1.7;" class="mobile-padding">
              ...
              <tr>
                <td align="center" style="padding:20px;">
                  <div style="position:relative;display:inline-block;">
                    <svg width="120" height="120" class="score-circle" style="transform:rotate(-90deg);">
                      <circle cx="60" cy="60" r="50" fill="none" stroke="#e5e7eb" stroke-width="6"/>
                      <circle cx="60" cy="60" r="50" fill="none" stroke="${Number(quizData.score) >= 80 ? '#10b981' : Number(quizData.score) >= 60 ? '#f59e0b' : '#ef4444'}" stroke-width="6" stroke-dasharray="${Math.PI * 100}" stroke-dashoffset="${Math.PI * 100 * (1 - Number(quizData.score) / 100)}" stroke-linecap="round"/>
                    </svg>
                    <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:90px;height:90px;border-radius:50%;background:${Number(quizData.score) >= 80 ? '#10b981' : Number(quizData.score) >= 60 ? '#f59e0b' : '#ef4444'};color:#fff;line-height:90px;font-size:32px;font-weight:bold;text-align:center;box-sizing:border-box;display:flex;align-items:center;justify-content:center;" class="score-badge">
                      <span style="line-height:1;">${quizData.score}%</span>
                    </div>
                  </div>
            ...
            <!-- Info Card -->
            <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);border:1px solid #e2e8f0;border-radius:12px;margin-bottom:20px;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
            ...
            <!-- QR Code Section -->
            <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);border-radius:12px;margin-bottom:20px;box-shadow:0 4px 12px rgba(79, 70, 229, 0.15);">
              <tr><td style="padding:20px;text-align:center;">
                <p style="margin:0 0 12px;font-size:14px;font-weight:600;color:#ffffff;">📱 Quick Mobile Access</p>
                <div style="background:#ffffff;padding:8px;border-radius:12px;display:inline-block;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                  <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&color=4f46e5&bgcolor=ffffff&data=https://quizzicallabz.qzz.io/dashboard?utm_source=email_qr" alt="QR Code" style="width:80px;height:80px;display:block;">
                </div>
                <p style="margin:12px 0 0;font-size:12px;color:#e0e7ff;">Scan to open on mobile</p>
              </td></tr>
            </table>
            ...
            <!-- Social Sharing -->
            <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);border:1px solid #0ea5e9;border-radius:12px;margin-bottom:20px;box-shadow:0 2px 8px rgba(14, 165, 233, 0.1);">
              <tr><td style="padding:20px;">
                <p style="margin:0 0 15px;font-size:14px;font-weight:600;color:#0c4a6e;text-align:center;">🎉 Share Your Achievement</p>
                <div class="social-buttons" style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;">
                  <a href="https://twitter.com/intent/tweet?text=Just+scored+${quizData.score}%25+on+${encodeURIComponent(quizData.quizTitle)}+quiz+with+@QuizzicallabzAI!+%F0%9F%8E%AF%0A%0AReady+to+test+your+knowledge?+Try+it+here:&url=https://quizzicallabz.qzz.io" target="_blank" class="social-button" style="background:#4f46e5;color:#fff;text-decoration:none;padding:10px 16px;border-radius:8px;font-size:12px;display:inline-flex;align-items:center;gap:6px;font-weight:600;box-shadow:0 2px 4px rgba(79, 70, 229, 0.2);transition:all 0.2s;">
        ...
        <tr>
          <td style="padding:30px;color:#333;font-size:15px;line-height:1.7;" class="mobile-padding">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
              <tr>
                <td align="center" style="padding:20px;">
                  <div style="display:inline-flex;width:80px;height:80px;border-radius:50%;background:#10b981;color:#fff;font-size:36px;text-align:center;box-sizing:border-box;align-items:center;justify-content:center;box-shadow:0 4px 12px rgba(16, 185, 129, 0.3);" class="welcome-badge">
...
export const studyReminderEmailTemplate = (userName: string, reminderData?: {
    ...
    <head>
      ...
      <style>
        @media only screen and (max-width: 600px) {
          ...
          .logo { width: 80px !important; }
          .button-container { text-align: center !important; }
          .reminder-badge { width: 50px !important; height: 50px !important; line-height: 50px !important; font-size: 24px !important; }
        }
        .icon { display: inline-block; width: 16px; height: 16px; vertical-align: middle; margin-right: 6px; }
      </style>
    </head>
        ...
        <tr>
          <td style="padding:30px;color:#333;font-size:15px;line-height:1.7;" class="mobile-padding">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
              <tr>
                <td align="center" style="padding:20px;">
                  <div style="display:inline-flex;width:80px;height:80px;border-radius:50%;background:#f59e0b;color:#fff;font-size:36px;text-align:center;box-sizing:border-box;align-items:center;justify-content:center;box-shadow:0 4px 12px rgba(245, 158, 11, 0.3);" class="reminder-badge">
                    <span style="line-height:1;">📚</span>
                  </div>
                  <h2 style="margin:15px 0 5px;font-size:24px;color:#111;font-weight:600;">
                    Don't Break Your Streak!
                  </h2>
                  <p style="margin:0;color:#6b7280;">Time to continue your learning journey</p>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 20px;">Hello <strong>${userName}</strong>,</p>
            <p style="margin:0 0 20px;">
              We noticed you haven't studied in a while. Consistency is the key to mastering any subject!
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);border:1px solid #e2e8f0;border-radius:12px;margin-bottom:20px;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
              <tr><td style="padding:20px;">
                <p style="margin:0 0 12px;font-size:14px;">
                  ...
                  <strong>Last Activity:</strong> ${reminderData?.lastActivity || 'A while ago'}
                </p>
                ...
                <p style="margin:0 0 12px;font-size:14px;">
                  ...
                  <strong>Areas to Review:</strong> ${reminderData.weakAreas.join(', ')}
                </p>
                ` : ''}
                <p style="margin:0;font-size:14px;">
                  <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2">
                  ...
                  <strong>Current Streak:</strong> ${reminderData?.streakDays || 0} days
                </p>
              </td></tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef3c7;border-left:4px solid #f59e0b;border-radius:6px;margin-bottom:20px;">
              <tr><td style="padding:15px;">
                <p style="margin:0 0 10px;font-size:14px;font-weight:600;color:#92400e;">💡 Daily Motivation</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#eff6ff;border-left:4px solid #3b82f6;border-radius:6px;margin-bottom:20px;">
              <tr><td style="padding:15px;">
                <p style="margin:0 0 10px;font-size:14px;font-weight:600;color:#1e40af;">🎯 Quick Study Tips</p>
                <ul style="margin:0;padding-left:20px;font-size:13px;color:#1e40af;line-height:1.6;">
                  <li>Review your weak areas first for maximum impact</li>
                  <li>Take short practice quizzes to stay sharp</li>
                  <li>Set aside 15 minutes daily for consistent progress</li>
                </ul>
              </td></tr>
            </table>
            ...
            <div class="button-container" style="text-align:left;">
              ...
              <a href="https://quizzicallabz.qzz.io/practice?utm_source=email&utm_medium=reminder&utm_campaign=engagement" target="_blank" rel="noopener noreferrer" style="border:1px solid #4f46e5;color:#4f46e5;text-decoration:none;padding:12px 24px;border-radius:6px;display:inline-block;font-weight:600;" class="mobile-button">
                <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="#4f46e5" stroke-width="2">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                  <polyline points="22 4 12 14.01 9 11.01"></polyline>
                </svg>
  ...
  `,
  text: `Don't Break Your Streak! - Study Reminder

Hello ${userName},

We noticed you haven't studied in a while. Consistency is the key to mastering any subject!

Last Activity: ${reminderData?.lastActivity || 'A while ago'}
${reminderData?.weakAreas && reminderData.weakAreas.length > 0 ? `Areas to Review: ${reminderData.weakAreas.join(', ')}` : ''}
