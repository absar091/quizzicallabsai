...
const addPdfHeaderAndFooter = (doc: any, title: string, difficulty: string, isPro: boolean) => {
    ...
    for (let i = 1; i <= pageCount; i++) {
        ...
        doc.setFontSize(16);
        doc.text("Quizzicallabzᴬᴵ™", pageWidth / 2, 15, { align: 'center' });
        ...
        if (!isPro) {
            ...
            doc.text("Quizzicallabzᴬᴵ", pageWidth / 2, pageHeight / 2, { angle: 45, align: 'center' });
        ...
        doc.text(`Generated by Quizzicallabzᴬᴵ™ - A Project By Absar Ahmad Rao`, pageWidth / 2, pageHeight - 10, { align: 'center' });
    }
}
