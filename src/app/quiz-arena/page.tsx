          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">{quizSetup.timePerQuestion}s</Badge>
              </div>
              <Slider
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">{quizSetup.maxPlayers}</Badge>
              </div>
              <Slider
            ...
            <div className="flex items-center space-x-2">
              <Switch
                id="allowLateJoining"
                checked={quizSetup.allowLateJoining}
                onCheckedChange={(checked) => setQuizSetup(prev => ({ ...prev, allowLateJoining: checked }))}
              />
              <Label htmlFor="allowLateJoining">Allow players to join after game starts</Label>
            </div>
          </CardContent>
