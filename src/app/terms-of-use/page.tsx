    ...
    <div className="container py-8 max-w-4xl mx-auto">
      ...
      <Card className="bg-muted/30">
        <CardContent className="pt-6 space-y-6 text-sm text-muted-foreground leading-relaxed">
          <p>
            Welcome to Quizzicallabs™. These Terms of Use ("Terms") govern your access to and use of our application and services ("Service"). By accessing or using our Service, you agree to be bound by these Terms.
          </p>

          <div className="space-y-2">
            <h2 className="text-xl font-semibold text-foreground">1. Accounts</h2>
            <p>When you create an account with us, you guarantee that you are above the age of 5 and that the information you provide is accurate, complete, and current. You are responsible for safeguarding the password that you use to access the Service and for any activities or actions under your password.</p>
          </div>

          <div className="space-y-2">
            <h2 className="text-xl font-semibold text-foreground">2. AI-Generated Content</h2>
            <p>Our Service uses artificial intelligence to generate content, including quizzes, study guides, and explanations ("AI Content"). You acknowledge that AI Content is probabilistic and may contain inaccuracies, errors, or omissions. It is provided for educational and informational purposes only.</p>
            <p>Quizzicallabs™ does not guarantee the accuracy, completeness, or reliability of any AI Content. You are solely responsible for verifying the information before relying on it for academic, professional, or other critical purposes. You agree to use the AI Content at your own risk.</p>
          </div>
           ...
           <div className="space-y-2">
            ...
            <p>You agree not to use the Service:</p>
             <ul className="list-disc list-inside pl-4 space-y-1">
                ...
                <li>To generate content that is defamatory, obscene, pornographic, abusive, or that infringes on any third party's rights.</li>
          ...
          <div className="space-y-2">
            ...
            <p>The Service and its original content (excluding content generated by users), features, and functionality are and will remain the exclusive property of Quizzicallabs™ and its licensors. Our trademarks may not be used in connection with any product or service without prior written consent.</p>
          </div>
